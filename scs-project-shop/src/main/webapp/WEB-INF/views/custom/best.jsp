            ...
            <div class="mobile-product-list">
	            <c:forEach items="${map.list }" var="vo">
                    ...
                    <div class="mobile-product-img">
                        <img src="${pageContext.request.contextPath}/assets/images/products/product-1.jpg" alt="product-pic" class="mobile-product-img-mg" />
                        <!-- best, new 노출 -->
                       	<c:if test="${vo.bestItem ==true }">
                       		 <span class="badge badge-pink" >BEST</span>
                       	</c:if>
                ...
                <div class="row">
                    <div class="col-12">
                        <ul class="pagination pagination-rounded justify-content-center mb-3">
                            <li class="page-item">
                                <a class="page-link" href="${pageContext.servletContext.contextPath }/${db }/custom/BEST?p=${map.prevPage}&kwd=${map.kwd}" aria-label="Previous">
								...
								<c:choose>
									<c:when test="${map.page == (map.beginPage+(i-1)) }">
										<li class ="page-item active">
											<a class="page-link" href="${pageContext.servletContext.contextPath }/${db }/custom/BEST?p=${map.beginPage+(i-1) }&kwd=${map.kwd}">${map.beginPage+(i-1) }</a>
										</li>
									</c:when>
									<c:otherwise>
										<li><a  class="page-link" href="${pageContext.servletContext.contextPath }/${db }/custom/BEST?p=${map.beginPage+(i-1) }&kwd=${map.kwd}">${map.beginPage+(i-1) }</a></li>
									</c:otherwise>
								
								</c:choose>
							</c:forEach>
                            <li>
                                <a class="page-link" href="${pageContext.servletContext.contextPath }/${db }/custom/BEST?p=${map.nextPage }&kwd=${map.kwd}" aria-label="Next">
                                    <span aria-hidden="true">»</span>
