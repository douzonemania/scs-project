        ...
        <div class="container-fluid">
            ...
            <div class="photo-review-group">
                <div class="photo-review-title">
                    PHOTO REVIEW  &nbsp&nbsp l &nbsp&nbsp  포토 리뷰
                </div>        

                
                
               <div class="review-search-group">
                    <div class="review-search-category" style="width: 15%;"><span class="review-category-span">카테고리</span></div>
                   
                    <div style="margin:10px; border: 1px solid #ffffff"></div>
                    <div ></div>
                    <div class="review-search-category">
                        <button class="btn btn-light btn-lg dropdown-toggle " style="width: 100%" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <div class="review-search-category3">
                        <i class="fe-search review-search-icon" style="font-size:36px; color:#ffffff; margin-left:30px"></i>
                    </div>
