            ...
            <div class="container-fluid">
                ...
                <div class="logo-box">
                    <a href="${ pageContext.request.contextPath }/${db }" class="logo text-center">
                        <span class="logo-lg">
                            <img src="/scs-manager${ceoVo.logo }'" onError="this.src='/scs-manager${logo }'"  alt="" style="max-height:64px; max-width:64px">
                            <!-- <span class="logo-lg-text-light">UBold</span> -->
                        </span>
                        <span class="logo-sm" style="margin-left: 120px;">
                            <!-- <span class="logo-sm-text-dark">U</span> -->
                            <img src="/scs-manager${ceoVo.logo }'" onError="this.src='/scs-manager${logo }'" alt="" style="max-height:48px; max-width:48px">
                        </span>
                    </a>
                </div>
