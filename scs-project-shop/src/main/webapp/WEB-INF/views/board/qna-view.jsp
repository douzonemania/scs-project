...
var removeCheck = function(no) {
	if (confirm("정말 삭제하시겠습니까??") == true) {    //확인
	 	...
	 	event.preventDefault();
			$.ajax({
				url: '${pageContext.servletContext.contextPath }/${db}/api/board/qna/delete/' + no,
				async: true,
				type: 'post',
				dataType: 'json',
				...
				success: function(response){
					location.href= "${pageContext.request.contextPath }/${db}/board/qna/list";
				},
							...
							<div class="btn-submit-section">
								...
								<button type="button" class="btn btn-secondary waves-effect" id="btn-list">
									목록</button></a>
										...
										<a href="">
											<button type="button" class="btn btn-secondary waves-effect" id="btn-list" onClick="removeCheck(${boardVo.no});">
											글삭제</button></a>
									</c:if> 
							</div>
