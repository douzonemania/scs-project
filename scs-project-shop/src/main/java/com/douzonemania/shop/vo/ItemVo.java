...
public class ItemVo {
	...
	public String toString() {
		return "ItemVo [no=" + no + ", code=" + code + ", name=" + name + ", supPrice=" + supPrice + ", nowPrice="
				...
				+ ", editor1=" + editor1 + ", des=" + des + ", regDate=" + regDate + ", categoryNo=" + categoryNo
				+ ", intRevAvg=" + intRevAvg + ", douRevAvg=" + douRevAvg + ", cnt=" + cnt + ", rate=" + rate
				+ ", totalPrice=" + totalPrice + ", stock=" + stock + ", amount=" + amount + ", cartNo=" + cartNo
				+ ", firstOption=" + firstOption + ", secondOption=" + secondOption + ", firstOptionName="
				+ firstOptionName + ", secondOptionName=" + secondOptionName + "]";
	}
