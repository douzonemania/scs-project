...
public class OrderController {
	...
	@ResponseBody
	@RequestMapping(value="/review/delete/{no}")
	public JsonResult deleteReview(@AuthUser CeoVo authUser,
				@PathVariable("no") int no) {
		
		boolean deleteResult = orderService.deleteReview(authUser.getId(), no);
