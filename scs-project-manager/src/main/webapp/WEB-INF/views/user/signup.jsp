                                        ...
                                        <div class="col-lg-6" style="margin-top: 15px">
                                            <div class="p-sm-3 signup-right">
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input class="form-control" type="text" id="company-number" required>
                                                    </div>
                                                    <div class="form-group mb-3">
                                                    ...
                                                    <div class="form-group mb-0">
                                                        <div class="custom-control custom-checkbox pt-1" style="z-index: 0;">
                                                            <button class="btn btn-secondary btn-sm float-right btn-signup" type="submit" style="position:absolute; right:0; bottom:0; z-index: 10;">가입하기</button>
