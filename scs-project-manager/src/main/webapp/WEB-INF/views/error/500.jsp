...
<body >
	<div class="col-lg-6 card-body" style="margin: 0 auto; margin-top: 10%;">
		<div style="margin-top: 10%; margin-left: 4%;">
			<img src="${ pageContext.request.contextPath }/assets/images/500error.jpg" alt="404 png 2" style="width: 340px;">
		...
		<div class="text-center" style="margin-top: 1%; margin-right: 40%; width: 100%;">
			<p>찾을 수 없는 페이지입니다.</p>
			<p>존재하지 않는 주소이거나,</p>
			<p style="margin-left: 1%;">요청하신 페이지의 주소가 변경, 삭제되어 찾을 수 없습니다.</p>
		</div>
	</div>
</body>
</html>